        ...
        appBar: AppBar(
          ...
          flexibleSpace: SafeArea(
            child: Container(
              ...
              /// Заголовок экрана
              child: Text(loc.ratingTitle, style: theme.textTheme.headlineLarge?.copyWith(color: colors.text)),
            ),
          ),
        ),
        body: vm.isLoading
            ...
            : vm.hasError
                ? Center(child: Text(loc.loadError, style: theme.textTheme.bodyLarge))  // сообщение об ошибке
                : Column(
                    children: [
                      /// Показывает топ-3 пользователей
                      Container(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                icon: SvgPicture.asset('lib/assets/icons/home.svg', width: 24, height: 24, color: colors.inactiveButtons),
                label: loc.home,
              ),
              BottomNavigationBarItem(
                icon: SvgPicture.asset('lib/assets/icons/line_medal.svg', width: 24, height: 24, color: colors.greetingText),
                label: loc.rating,
              ),
              BottomNavigationBarItem(
